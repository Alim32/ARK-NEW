...
const MintButton = ({
    ...
    const wait = useWaitForTransaction({
        ...
        onSuccess() {
            ...
            var item = document.getElementById("mint-btn") as HTMLButtonElement;
            var item2 = document.getElementById("mint-loader") as HTMLElement;
            var item3 = document.getElementById("mint-success") as HTMLElement;
            item.style.display = "none";
            item2.style.display = "none";
    ...
    return (
        <div className='flex flex-col w-[100%]'>
            ...
            <div className='flex flex-col items-center justify-center w-100% hidden mb-10 mt-4' id='mint-success'>
                <Image
