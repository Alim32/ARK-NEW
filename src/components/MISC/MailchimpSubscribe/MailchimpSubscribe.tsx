...
const MailchimpForm = () => {
  ...
  return (
    <form onSubmit={subscribe} id='subscribe-form' className='relative mt-5 md:mt-11 '>
      ...
      <div
        className={`max-w-sm text-sm pt-2 ${
          success !== null && !success ? 'text-red-600' : 'text-f-orange'
        }`}
